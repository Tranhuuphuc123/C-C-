...
int main(){
  ...
  /* in thông tin địa chỉ định danh cho biến, tưc địa chỉ đc khai báo cho biến
     thông qua đó vùng nhớ RAm có thể tìm đến đc biến a nhờ địa chỉ gán đó và truy xuất được số nguyên 100*/
